...
_oss_mode = (
    os.environ.get('OMI_AUTH_BACKEND', 'firebase').lower() == 'supabase'
    and os.environ.get('OMI_DB_BACKEND', 'firestore').lower() == 'supabase'
)
if not _oss_mode:
...
app.include_router(oss_user.router)
app.include_router(oss_config.router)
