...
# To add a new backend: create utils/other/storage_backends/<name>.py with a
# create_storage_client() factory and GCS-compatible classes, then add an
# elif branch below.
# ---------------------------------------------------------------------------
...
if _MINIO_ENDPOINT:
    from utils.other.storage_backends.minio import create_storage_client, MinIONotFound
    BlobNotFound = MinIONotFound
    NotFound = MinIONotFound
