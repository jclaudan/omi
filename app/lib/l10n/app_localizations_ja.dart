...
class AppLocalizationsJa extends AppLocalizations {
  ...
  @override
  String get modeSelectorTitle => 'モードを選択';

  @override
  String get officialModeTitle => '公式';

  @override
  String get officialModeDescription => 'Omi Cloud — 設定不要。';

  @override
  String get opensourcePlusModeTitle => 'オープンソース+';

  @override
  String get opensourcePlusModeDescription => 'セルフホスト — 完全なプライバシー、有料APIなし。';

  @override
  String get ossSetupTitle => 'Open Source+ セットアップ';

  @override
  String get ossSetupWelcomeBody => 'サービスを設定します。約5分かかります。';

  @override
  String get ossAuthSubtitle => '認証とデータベース';

  @override
  String get ossSpeechSubtitle => '音声認識';

  @override
  String get ossVectorSubtitle => 'ベクターデータベース';

  @override
  String get ossStorageSubtitle => 'オブジェクトストレージ';

  @override
  String get ossLocalAiSubtitle => 'ローカルAIモデル';

  @override
  String get ossConnectionTestTitle => '接続テスト';

  @override
  String get ossConnectionTestSubtitle => 'サービスをテスト中…';

  @override
  String get ossConnected => '接続済み';

  @override
  String get ossUnreachable => '接続不可';

  @override
  String get ossFinish => 'Omiを使い始める';
  ...
  @override
  String get ossHealthTitle => 'OSS+ サービス';

  @override
  String get ossHealthSubtitle => 'セルフホストスタックの状態';

  @override
  String get ossHealthTestNow => '今すぐテスト';

  @override
  String get ossHealthReconfigure => '再設定';

  @override
  String get ossHealthSlow => '遅い';
}
