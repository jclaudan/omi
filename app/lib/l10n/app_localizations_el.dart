...
class AppLocalizationsEl extends AppLocalizations {
  ...
  @override
  String get modeSelectorTitle => 'Επιλέξτε τη λειτουργία';

  @override
  String get officialModeTitle => 'Επίσημο';

  @override
  String get officialModeDescription => 'Omi Cloud — χωρίς ρύθμιση.';

  @override
  String get opensourcePlusModeTitle => 'Ανοιχτός κώδικας+';

  @override
  String get opensourcePlusModeDescription => 'Αυτο-φιλοξενία — πλήρες απόρρητο, χωρίς επί πληρωμή API.';

  @override
  String get ossSetupTitle => 'Ρύθμιση Open Source+';

  @override
  String get ossSetupWelcomeBody => 'Ρυθμίστε τις υπηρεσίες σας. Χρειάζεται περίπου 5 λεπτά.';

  @override
  String get ossAuthSubtitle => 'Αυθεντικοποίηση και βάση δεδομένων';

  @override
  String get ossSpeechSubtitle => 'Αναγνώριση ομιλίας';

  @override
  String get ossVectorSubtitle => 'Διανυσματική βάση δεδομένων';

  @override
  String get ossStorageSubtitle => 'Αποθήκευση αντικειμένων';

  @override
  String get ossLocalAiSubtitle => 'Τοπικό μοντέλο AI';

  @override
  String get ossConnectionTestTitle => 'Δοκιμή σύνδεσης';

  @override
  String get ossConnectionTestSubtitle => 'Δοκιμή υπηρεσιών…';

  @override
  String get ossConnected => 'Συνδέθηκε';

  @override
  String get ossUnreachable => 'Μη προσβάσιμο';

  @override
  String get ossFinish => 'Ξεκινήστε να χρησιμοποιείτε το Omi';
  ...
  @override
  String get ossHealthTitle => 'Υπηρεσίες OSS+';

  @override
  String get ossHealthSubtitle => 'Κατάσταση του αυτο-φιλοξενούμενου stack σας';

  @override
  String get ossHealthTestNow => 'Δοκιμή τώρα';

  @override
  String get ossHealthReconfigure => 'Επαναδιαμόρφωση';

  @override
  String get ossHealthSlow => 'Αργό';
}
