...
class AppLocalizationsFa extends AppLocalizations {
  ...
  String get reportMessageConfirm =>
      'آیا مطمئن هستید که می‌خواهید این پیام را گزارش کنید؟';
  ...
  String get clearChatConfirm =>
      'آیا مطمئن هستید که می‌خواهید چت را پاک کنید؟ این عمل قابل بازگشت نیست.';
  ...
  String get backgroundActivityDesc =>
      'اجازه دهید Omi در پس‌زمینه اجرا شود برای پایداری بهتر';
  ...
  String get actionItemMarkedIncomplete =>
      'موارد اقدام به‌عنوان ناتکمیل علامت‌گذاری شد';
  ...
  String get deleteActionItemMessage =>
      'آیا مطمئن هستید که می‌خواهید این موارد اقدام را حذف کنید؟';
  ...
  String get clearMemoryMessage =>
      'آیا مطمئن هستید که می‌خواهید حافظه Omi را پاک کنید؟ این اقدام قابل برگشت نیست.';
  ...
  String get actionItemDescriptionEmpty =>
      'توصیف موارد اقدام نمی‌تواند خالی باشد.';
  ...
  String get actionItemDescriptionCannotBeEmpty =>
      'توضیح مورد اقدام نمی‌تواند خالی باشد';
  ...
  String get startCapturingConversations =>
      'برای مشاهده گفتگوها در اینجا، شروع به ضبط گفتگوها با دستگاه Omi خود کنید.';
  ...
  String get actionItemUpdatedSuccessfully =>
      'مورد اقدام با موفقیت بروزرسانی شد';
  ...
  String get startRecordingToSeeTranscript =>
      'برای مشاهده رونوشت زنده، ضبط را شروع کنید';
  ...
  String get premiumMinutesInfo =>
      '600 دقیقه premium/ماه. برگه On-Device رونویسی رایگان نامحدود را ارائه می دهد.';
  ...
  @override
  String get modeSelectorTitle => 'حالت خود را انتخاب کنید';

  @override
  String get officialModeTitle => 'رسمی';

  @override
  String get officialModeDescription =>
      'Omi Cloud — نیازی به راه‌اندازی ندارد.';

  @override
  String get opensourcePlusModeTitle => 'متن‌باز+';

  @override
  String get opensourcePlusModeDescription =>
      'خودمیزبانی — حریم خصوصی کامل، بدون API پولی.';

  @override
  String get ossSetupTitle => 'راه‌اندازی Open Source+';

  @override
  String get ossSetupWelcomeBody =>
      'سرویس‌های خود را پیکربندی کنید. حدود ۵ دقیقه طول می‌کشد.';

  @override
  String get ossAuthSubtitle => 'احراز هویت و پایگاه داده';

  @override
  String get ossSpeechSubtitle => 'تشخیص گفتار';

  @override
  String get ossVectorSubtitle => 'پایگاه داده برداری';

  @override
  String get ossStorageSubtitle => 'ذخیره‌سازی اشیاء';

  @override
  String get ossLocalAiSubtitle => 'مدل هوش مصنوعی محلی';

  @override
  String get ossConnectionTestTitle => 'آزمایش اتصال';

  @override
  String get ossConnectionTestSubtitle => 'در حال آزمایش سرویس‌ها…';

  @override
  String get ossConnected => 'متصل';

  @override
  String get ossUnreachable => 'غیرقابل دسترس';

  @override
  String get ossFinish => 'استفاده از Omi را شروع کنید';
