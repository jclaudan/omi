...
class AppLocalizationsFa extends AppLocalizations {
  ...
  @override
  String get officialModeDescription => 'Omi Cloud — نیازی به راه‌اندازی ندارد.';

  @override
  String get opensourcePlusModeTitle => 'متن‌باز+';

  @override
  String get opensourcePlusModeDescription => 'خودمیزبانی — حریم خصوصی کامل، بدون API پولی.';

  @override
  String get ossSetupTitle => 'راه‌اندازی Open Source+';

  @override
  String get ossSetupWelcomeBody => 'سرویس‌های خود را پیکربندی کنید. حدود ۵ دقیقه طول می‌کشد.';
  ...
  @override
  String get ossHealthTitle => 'سرویس‌های OSS+';

  @override
  String get ossHealthSubtitle => 'وضعیت پشته خود-میزبانی شما';

  @override
  String get ossHealthTestNow => 'همین الان تست کن';

  @override
  String get ossHealthReconfigure => 'بازپیکربندی';

  @override
  String get ossHealthSlow => 'کند';
}
