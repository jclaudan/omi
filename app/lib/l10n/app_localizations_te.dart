...
class AppLocalizationsTe extends AppLocalizations {
  ...
  @override
  String get modeSelectorTitle => 'మీ మోడ్ ఎంచుకోండి';

  @override
  String get officialModeTitle => 'అధికారిక';

  @override
  String get officialModeDescription => 'Omi Cloud — సెటప్ అవసరం లేదు.';

  @override
  String get opensourcePlusModeTitle => 'ఓపెన్ సోర్స్+';

  @override
  String get opensourcePlusModeDescription => 'స్వయం-హోస్ట్ — పూర్తి గోప్యత, చెల్లింపు API లేదు.';

  @override
  String get ossSetupTitle => 'Open Source+ సెటప్';

  @override
  String get ossSetupWelcomeBody => 'మీ సేవలను కాన్ఫిగర్ చేయండి. ఇది సుమారు 5 నిమిషాలు పడుతుంది.';

  @override
  String get ossAuthSubtitle => 'ప్రమాణీకరణ మరియు డేటాబేస్';

  @override
  String get ossSpeechSubtitle => 'వాక్ గుర్తింపు';

  @override
  String get ossVectorSubtitle => 'వెక్టర్ డేటాబేస్';

  @override
  String get ossStorageSubtitle => 'ఆబ్జెక్ట్ స్టోరేజ్';

  @override
  String get ossLocalAiSubtitle => 'స్థానిక AI మోడల్';

  @override
  String get ossConnectionTestTitle => 'కనెక్షన్ పరీక్ష';

  @override
  String get ossConnectionTestSubtitle => 'మీ సేవలు పరీక్షిస్తున్నారు…';

  @override
  String get ossConnected => 'కనెక్ట్ అయింది';

  @override
  String get ossUnreachable => 'అందుబాటులో లేదు';

  @override
  String get ossFinish => 'Omi ఉపయోగించడం ప్రారంభించండి';
  ...
  @override
  String get ossHealthTitle => 'OSS+ సేవలు';

  @override
  String get ossHealthSubtitle => 'మీ స్వీయ-హోస్ట్ చేసిన స్టాక్ స్థితి';

  @override
  String get ossHealthTestNow => 'ఇప్పుడే పరీక్షించండి';

  @override
  String get ossHealthReconfigure => 'తిరిగి కాన్ఫిగర్ చేయండి';

  @override
  String get ossHealthSlow => 'నెమ్మది';
}
