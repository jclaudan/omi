...
class AppLocalizationsTe extends AppLocalizations {
  ...
  String get freeMinutesMonth =>
      '600 ఉచిత నిమిషాలు/నెల చేర్చబడ్డాయి. అসীమితమైన ';
  ...
  String get basicPlanDescription =>
      '600 ప్రీమియం నిమిషాలు + ఆన్-డివైస్‌లో అన్‌లిమిటెడ్';
  ...
  String get opensourcePlusModeDescription =>
      'స్వయం-హోస్ట్ — పూర్తి గోప్యత, చెల్లింపు API లేదు.';
  ...
  String get ossSetupWelcomeBody =>
      'మీ సేవలను కాన్ఫిగర్ చేయండి. ఇది సుమారు 5 నిమిషాలు పడుతుంది.';
