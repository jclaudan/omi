...
class AppLocalizationsUr extends AppLocalizations {
  ...
  String get premiumMinutesInfo =>
      'ماہانہ 600 پریمیم منٹ۔ On-Device ٹیب غیر محدود مفت ٹرانسکریپشن فراہم کرتا ہے۔';
  ...
  String get opensourcePlusModeDescription =>
      'سیلف ہوسٹڈ — مکمل رازداری، کوئی ادا شدہ API نہیں۔';
  ...
  String get ossSetupWelcomeBody =>
      'اپنی سروسز کنفیگر کریں۔ اس میں تقریباً 5 منٹ لگتے ہیں۔';
