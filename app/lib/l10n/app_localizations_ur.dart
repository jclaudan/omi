...
class AppLocalizationsUr extends AppLocalizations {
  ...
  @override
  String get modeSelectorTitle => 'اپنا موڈ منتخب کریں';

  @override
  String get officialModeTitle => 'سرکاری';

  @override
  String get officialModeDescription => 'Omi Cloud — کوئی سیٹ اپ ضروری نہیں۔';

  @override
  String get opensourcePlusModeTitle => 'اوپن سورس+';

  @override
  String get opensourcePlusModeDescription => 'سیلف ہوسٹڈ — مکمل رازداری، کوئی ادا شدہ API نہیں۔';

  @override
  String get ossSetupTitle => 'Open Source+ سیٹ اپ';

  @override
  String get ossSetupWelcomeBody => 'اپنی سروسز کنفیگر کریں۔ اس میں تقریباً 5 منٹ لگتے ہیں۔';

  @override
  String get ossAuthSubtitle => 'توثیق اور ڈیٹا بیس';

  @override
  String get ossSpeechSubtitle => 'تقریر کی پہچان';

  @override
  String get ossVectorSubtitle => 'ویکٹر ڈیٹا بیس';

  @override
  String get ossStorageSubtitle => 'آبجیکٹ اسٹوریج';

  @override
  String get ossLocalAiSubtitle => 'مقامی AI ماڈل';

  @override
  String get ossConnectionTestTitle => 'کنکشن ٹیسٹ';

  @override
  String get ossConnectionTestSubtitle => 'آپ کی سروسز کی جانچ ہو رہی ہے…';

  @override
  String get ossConnected => 'منسلک';

  @override
  String get ossUnreachable => 'ناقابل رسائی';

  @override
  String get ossFinish => 'Omi استعمال شروع کریں';
  ...
  @override
  String get ossHealthTitle => 'OSS+ خدمات';

  @override
  String get ossHealthSubtitle => 'آپ کے سیلف ہوسٹڈ اسٹیک کی حالت';

  @override
  String get ossHealthTestNow => 'ابھی ٹیسٹ کریں';

  @override
  String get ossHealthReconfigure => 'دوبارہ ترتیب دیں';

  @override
  String get ossHealthSlow => 'سست';
}
