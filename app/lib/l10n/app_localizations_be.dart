...
class AppLocalizationsBe extends AppLocalizations {
  ...
  @override
  String get opensourcePlusModeDescription => 'Уласны хостынг — поўная прыватнасць, без платнага API.';

  @override
  String get ossSetupTitle => 'Наладка Open Source+';

  @override
  String get ossSetupWelcomeBody => 'Наладзьце свае сэрвісы. Гэта займае каля 5 хвілін.';
  ...
  @override
  String get ossHealthTitle => 'Сэрвісы OSS+';

  @override
  String get ossHealthSubtitle => 'Статус вашага самастойна размешчанага стэка';

  @override
  String get ossHealthTestNow => 'Праверыць зараз';

  @override
  String get ossHealthReconfigure => 'Перанастроіць';

  @override
  String get ossHealthSlow => 'Павольна';
}
