...
abstract class AppLocalizations {
  ...
  /// OSS+ health dashboard page title
  ///
  /// In en, this message translates to:
  /// **'OSS+ Services'**
  String get ossHealthTitle;

  /// OSS+ health dashboard subtitle
  ///
  /// In en, this message translates to:
  /// **'Status of your self-hosted stack'**
  String get ossHealthSubtitle;

  /// OSS+ health dashboard: force immediate health check
  ///
  /// In en, this message translates to:
  /// **'Test Now'**
  String get ossHealthTestNow;

  /// OSS+ health dashboard: link to reconfigure a service
  ///
  /// In en, this message translates to:
  /// **'Reconfigure'**
  String get ossHealthReconfigure;

  /// OSS+ health dashboard: high latency status label
  ///
  /// In en, this message translates to:
  /// **'Slow'**
  String get ossHealthSlow;
}
