...
class AppLocalizationsUk extends AppLocalizations {
  ...
  String get deletingMessages =>
      'Видалення ваших повідомлень з пам\'яті Omi...';
  ...
  String get providingSubtitle =>
      'Завдання та нотатки, автоматично зафіксовані.';
  ...
  String get freeMinutesMonth =>
      '600 безкоштовних хвилин/місяць включено. Необмежено з ';
  ...
  String get backgroundActivityDesc =>
      'Дозвольте Omi працювати у фоновому режимі для кращої стабільності';
  ...
  String get locationAccessDesc =>
      'Увімкніть фонове місцезнаходження для повного досвіду';
  ...
  String get deleteActionItemMessage =>
      'Ви впевнені, що хочете видалити цей елемент дії?';
  ...
  String get actionItemsCopiedToClipboard =>
      'Елементи дій скопійовано в буфер обміну';
  ...
  String get actionItemDescriptionCannotBeEmpty =>
      'Опис елемента дії не може бути порожнім';
  ...
  String get startRecordingToSeeTranscript =>
      'Розпочніть запис, щоб побачити живий транскрипт';
  ...
  String get capturingAudioAndGeneratingTranscript =>
      'Запис аудіо та створення транскрипту';
  ...
  String get basicPlanDescription =>
      '1 200 преміум хвилин + необмежено на пристрої';
  ...
  String get transcriptionReconnecting =>
      'Повторне підключення транскрипції...';
  ...
  @override
  String get modeSelectorTitle => 'Оберіть режим';

  @override
  String get officialModeTitle => 'Офіційний';

  @override
  String get officialModeDescription => 'Omi Cloud — налаштування не потрібне.';

  @override
  String get opensourcePlusModeTitle => 'Відкритий код+';

  @override
  String get opensourcePlusModeDescription =>
      'Власний хостинг — повна конфіденційність, без платного API.';

  @override
  String get ossSetupTitle => 'Налаштування Open Source+';

  @override
  String get ossSetupWelcomeBody =>
      'Налаштуйте свої сервіси. Це займе близько 5 хвилин.';

  @override
  String get ossAuthSubtitle => 'Автентифікація та база даних';

  @override
  String get ossSpeechSubtitle => 'Розпізнавання мовлення';

  @override
  String get ossVectorSubtitle => 'Векторна база даних';

  @override
  String get ossStorageSubtitle => 'Об\'єктне сховище';

  @override
  String get ossLocalAiSubtitle => 'Локальна AI модель';

  @override
  String get ossConnectionTestTitle => 'Тест підключення';

  @override
  String get ossConnectionTestSubtitle => 'Тестування сервісів…';

  @override
  String get ossConnected => 'Підключено';

  @override
  String get ossUnreachable => 'Недоступно';

  @override
  String get ossFinish => 'Почніть користуватися Omi';
